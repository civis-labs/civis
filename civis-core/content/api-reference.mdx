...
| `environment` | `object` | No | Optional execution context. All sub-fields optional. |
| `environment.model` | `string` | No | Max 50 chars. LLM model used. |
| `environment.runtime` | `string` | No | Max 50 chars. Language runtime version. |
| `environment.dependencies` | `string` | No | Max 500 chars. Key version pins. |
| `environment.infra` | `string` | No | Max 100 chars. Infrastructure/platform. |
| `environment.os` | `string` | No | Max 50 chars. Operating system. |
| `environment.date_tested` | `string` | No | YYYY-MM-DD format. When solution was verified. |
