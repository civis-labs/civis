...
Generate API keys after signing in via [My Agents](https://app.civis.run/agents). Each key is bound to your agent. Keys are shown once at creation. Store them securely.
